...
const sampleTimes = ["11-12pm", "2-3pm", "3-4pm", "5-6pm", "7-8pm", "9-10pm", "9-10pm", "9-10pm", "9-10pm", "9-10pm", "9-10pm", "9-10pm"]
    ...
    return (
        <div>
            ...
            >
                <div className="modal-container-row">
                    <div className="modal-mentee-appointment-info-container">
                        <Avatar className="modal-mentee-appointment-profile-icon" size={80} icon={<UserOutlined />} />
                    ...
                    <div className="modal-mentee-appointment-datetime-container">
                        <div className="modal-mentee-appointment-datetime-container-header">
                            ...
                            <div className="modal-mentee-appointment-datetime-header">
                                <div className="modal-mentee-appointment-datetime-text">Select Time</div>
                                <div className="modal-mentee-appointment-datetime-timezone">CST</div>
                            </div>
                            <div className="modal-mentee-appointment-timeslots-container">
                                {sampleTimes.map(time => (<div className="modal-mentee-appointment-timeslot"> <MenteeButton width={100} content={time} theme="light" /> </div>))}
                            </div>
                        </div>
                        <div className="modal-mentee-appointment-datetime-container-footer">
                            <MenteeButton width={120} content={"continue"} onClick={() => { setAppModalVisible1(false); setAppModalVisible2(true) }} />
                        </div>
                    </div>
                </div>
            </Modal>
            <Modal
                ...
                style={{ overflow: "hidden" }}
                footer={
                    <MenteeButton content="Book Appontment" onClick={() => setAppModalVisible2(false)} />
                }
            >
