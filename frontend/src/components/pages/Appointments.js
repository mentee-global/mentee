  ...
  const Appointment = (props) => {
    return (
      <div className="appointment-card">
        ...
        <Button className="appointment-more-details" icon={<MenuOutlined/>} type="text"></Button>
      </div>
    )
  }
            ...
            <div className="appointments-background">
              <div className="appointments-date">
                ...
                <div style={{
                  ...
                  <Appointment name="Leo" time="12pm - 2pm" description="the watersJust testing the watersJust testing the waters"/>
                  <Appointment name="Leo" time="12pm - 2pm" description="the watersJust testing the watersJust testing the waters"/>
                  <Appointment name="Leo" time="12pm - 2pm" description="the watersJust testing the watersJust testing the waters"/>
                </div>
              </div>
