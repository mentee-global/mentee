...
function Home() {
  ...
  const [inputClicked, setInputClicked] = useState(new Array(2).fill(false)); // Sets one boolean for email and password
        ...
        <div className="home-content">
          <div className="home-text-container">
            ...
            <p className="home-text">
              Find a mentors from a diverse pool of backgrounds with experience
              in 18+ specializations, 15 different languages at locations all
              across the country.
            </p>
            <br />
            <NavLink to="/gallery">
  ...
  return <div className="home-background">{HomePage()}</div>;
}
