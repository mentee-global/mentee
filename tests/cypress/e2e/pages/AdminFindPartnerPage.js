export class FindPartner {
    clickFindPartner() {
        cy.get('.ant-menu-title-content').eq(3)
            .click()
    }
    selectOrganization() {
        ...
        // })
        cy.get('#root > section > main > div.gallery-container > div:nth-child(1) > div > div > span:nth-child(2)')
            .clear()
            .should('have.value', '')
    }
    selectRegions() {
