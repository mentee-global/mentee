...
const role1=1;const role2=2;const role3=3;const role4=4
    ...
    changeLanguagePage1() {
        ...
        I18N_LANGUAGES.map((language, index) => {
            ...
            cy.readFile(translationPath).then((currentLanguage) => {
                ...
                // Checking the texts
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.ant-steps.ant-steps-horizontal.css-wxm1m1.ant-steps-small.ant-steps-label-horizontal > div.ant-steps-item.ant-steps-item-process.ant-steps-item-active > div > div.ant-steps-item-content > div')
                    .should('contain.text', currentLanguage.common.role)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.ant-space.css-wxm1m1.ant-space-vertical.css-3w4dbw > div:nth-child(1) > div > div > div > div.ant-card-meta-detail > div > div')
                    .should('contain.text', currentLanguage.common.mentor)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.ant-space.css-wxm1m1.ant-space-vertical.css-3w4dbw > div:nth-child(2) > div > div > div > div.ant-card-meta-detail > div > div')
                    .should('contain.text', currentLanguage.common.mentee)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.ant-space.css-wxm1m1.ant-space-vertical.css-3w4dbw > div:nth-child(3) > div > div > div > div.ant-card-meta-detail > div > div')
                    .should('contain.text', currentLanguage.common.partner)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.ant-space.css-wxm1m1.ant-space-vertical.css-3w4dbw > div:nth-child(4) > div > div > div > div.ant-card-meta-detail > div > div')
    ...
    changeLanguagePage2() {
        ...
        I18N_LANGUAGES.map((language, index) => {
            ...
            cy.readFile(translationPath).then((currentLanguage) => {
                ...
                cy.contains(previousLanguage.languages[language.value.split("-")[0]]).click()
                // Checking the texts
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.ant-steps.ant-steps-horizontal.css-wxm1m1.ant-steps-small.ant-steps-label-horizontal > div.ant-steps-item.ant-steps-item-finish > div > div.ant-steps-item-content > div')
                    .should('contain.text', currentLanguage.common.role)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.css-1j25lv9 > h2')
                    .should('contain.text', currentLanguage.common.mentor)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.css-1j25lv9 > form > div:nth-child(1) > div > div.ant-col.ant-form-item-label.css-wxm1m1 > label')
                    .should('contain.text', currentLanguage.common.email)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.css-1j25lv9 > form > div:nth-child(2) > div > div.ant-col.ant-form-item-label.css-wxm1m1 > label')
                    .should('contain.text', currentLanguage.common.password)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.css-1j25lv9 > form > div:nth-child(3) > div > div > div > div > button')
                    .should('contain.text', currentLanguage.common.login)
                cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div.css-1j25lv9 > form > div:nth-child(3) > div > div > div > div > a')
