...
describe('Apply Page', () => {
    ...
    it('Is the apply page Elements visible', () => {
        ...
        cy.get('.ant-btn.css-wxm1m1.ant-btn-primary.ant-btn-lg').should('have.text', 'Submit');;
    ...
    it('Is countunue button and steps are correct', () => {
        ...
        cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div > form > div:nth-child(3) > div > div > div > div > div > div.ant-steps-item.ant-steps-item-process.ant-steps-item-active > div > div.ant-steps-item-content > div').should('have.text', 'Apply');

        cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div > form > div:nth-child(3) > div > div > div > div > div > div:nth-child(2) > div > div.ant-steps-item-content > div')
       .should('have.text', 'Training');

       cy.get('#root > section > main > div > div.ant-col.ant-col-11.css-qqdj8t.css-wxm1m1 > div.css-1c9mpvn > div > form > div:nth-child(3) > div > div > div > div > div > div:nth-child(3) > div > div.ant-steps-item-content > div').should('have.text', 'Build Profile');
    ...
    it('If email is improper', () => {
        ...
        cy.get('span[role="img"][aria-label="close-circle"].anticon.anticon-close-circle').should('exist');
    });
