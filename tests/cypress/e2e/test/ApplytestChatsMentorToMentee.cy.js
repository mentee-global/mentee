...
describe('Test for chats', () => {
    ...
    it('Login as a Mentor and send a message to mentee', () => {
        ...
        cy.get('#message').clear().type('Hey Mentee how are you i hope you will be fine');
    ...
    it('Login as a mentee and test message is recieved or not or test the text in message ', () => {
        ...
        cy.get('#root > section > main > section > aside > div > div.messages-sidebar > div').click();

        cy.wait(4000);
     
        cy.get('#root > section > main > section > section > div > div.conversation-content > div.ant-spin-nested-loading.css-wxm1m1 > div > div:nth-child(46) > div > div > div > div')
